    ...
    <div className="px-6 py-20">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center">
          <p className="font-hand text-2xl text-accent-500 mb-2">
            The honest pitch
          </p>
        ...
        <div className="mt-20 grid sm:grid-cols-2 gap-6">
          <div className="p-6 rounded-2xl border border-[var(--border)] bg-[var(--surface)]">
            <p className="font-hand text-xl text-accent-500 mb-1">You get</p>
          ...
          <div className="p-6 rounded-2xl border border-[var(--border)] bg-[var(--surface)]">
            <p className="font-hand text-xl text-accent-500 mb-1">I get</p>
            <ul className="mt-4 space-y-3 text-sm">
              <li className="flex items-start gap-2.5">
                <Check />
